...
3. 計画2 完了時点は **234 passed**。本計画で増えるのは Task 7 の 6 件だけで、最終的に **248 passed, 0 failed** になる
...
Expected: `Result: 248 passed, 0 failed`
...
| Task 7 完了 | **248 passed, 0 failed** |
| Task 10 完了 | **248 passed, 0 failed** |

**この計画の完了条件は `Result: 248 passed, 0 failed`。**
