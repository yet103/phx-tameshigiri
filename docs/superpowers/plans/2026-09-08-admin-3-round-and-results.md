...
3. 計画2 完了時点は **234 passed**。本計画で増えるのは（レビューでの追加分を含め）、最終的に **267 passed, 0 failed** になる
...
| Task 7 完了 | **267 passed, 0 failed** |
| Task 10 完了 | **267 passed, 0 failed** |

**この計画の完了条件は `Result: 267 passed, 0 failed`。**
