...
**前提計画:** [2026-09-08-admin-1-server-api.md](2026-09-08-admin-1-server-api.md)（**着地していること**。完了時点のテスト件数は 172）
...
計画1完了時点の `test.html` は **172 passed, 0 failed**。この計画で **15 件**足し、完了時点で **187 passed, 0 failed** になる。着手前に 172 を実測で確認すること。
...
- [ ] `test.html` が `Result: 187 passed, 0 failed`
